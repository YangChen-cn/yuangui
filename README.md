...
<p align="center">
  一只会陪伴、看天气、关注 Mac 状态，也能和你聊天的原生 macOS 桌宠。
</p>
...
<p align="center">
  ...
  <a href="https://github.com/YangChen-cn/yuangui/releases/latest/download/YuanGUI-1.0.1.dmg"><img alt="下载最新版 DMG" src="https://img.shields.io/badge/下载最新版-DMG-2ea44f?logo=github"></a>
</p>

## 项目简介

“元圭与 VCC”是一款使用 SwiftUI、AppKit 和 Swift Package Manager 开发的原生 macOS 桌宠。它把角色陪伴、系统状态、天气、AI 对话和基础维护工具放在一个轻量的透明悬浮面板中。
...
[一键下载最新版 `YuanGUI-1.0.1.dmg`](https://github.com/YangChen-cn/yuangui/releases/latest/download/YuanGUI-1.0.1.dmg)

1. 打开 `YuanGUI-1.0.1.dmg`。
...
│   ├── Services/     # 系统指标、天气、AI、存储与清理服务
│   ├── Stores/       # 桌宠、聊天、设置和维护状态
