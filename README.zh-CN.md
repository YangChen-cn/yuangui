...
<p align="center">
  ...
  <a href="https://github.com/YangChen-cn/yuangui/releases/latest/download/YuanGUI-2.7.2.dmg"><img alt="下载最新版 DMG" src="https://img.shields.io/badge/下载最新版-DMG-2ea44f?logo=github"></a>
</p>
...
当前稳定版本为 `2.8.0`。这次更新加入原生翻译朗读、更可靠的音乐窗口、FinderSync 右键扩展，并让桌宠成为应用入口：首次启动引导（按钮直接执行真实功能）、桌宠右键工具菜单和一次性功能发现提示。详情见 [2.8.0 更新说明](RELEASE_NOTES.zh-CN.md#280--原生翻译朗读与更可靠的音乐窗口)。
...
- **桌宠新手导览与功能发现**：首次启动由元圭和 VCC 用引导气泡带你认识右键工具菜单、截图与翻译、Finder 右键增强，按钮直接执行真实功能；桌宠右键菜单成为工具入口；轻量功能提示只出现一次并自动跳过你已经用过的功能，可在设置中关闭；桌宠菜单和设置 → 通用里都能重新观看导览。
...
[一键下载最新版 `YuanGUI-2.7.2.dmg`](https://github.com/YangChen-cn/yuangui/releases/latest/download/YuanGUI-2.7.2.dmg)

1. 打开 `YuanGUI-2.7.2.dmg`。
