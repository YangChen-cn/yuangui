...
final class LocalizationTests: XCTestCase {
    ...
    func testDiaryAndQuickToolsRuntimeKeysExistInBothLanguagesAndFormatInEnglish() {
        let keys = [
            ...
            "朗读译文",
            "停止朗读译文",
            "translation.mascot.title",
            "translation.source.roleTitle",
            "translation.result.roleTitle",
            "translation.footer.ready",
            "translation.status.translating",
            "translation.status.finished",
            "translation.status.failed",
            "translation.pet.translating",
            "translation.pet.finished",
            "translation.pet.failed",
