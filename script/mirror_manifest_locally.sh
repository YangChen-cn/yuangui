...
#
# 用法：
#   VERSION=2.9.0 BUILD=22 GITEE_TOKEN=xxx ./script/mirror_manifest_locally.sh
...
: "${VERSION:?VERSION is required, for example VERSION=2.9.0}"
: "${BUILD:?BUILD is required, for example BUILD=22}"
